...
export const dictionaries: Record<Language, Translation> = {
  en: {
    ...
    listen: "Listen", stop: "Stop", print: "Print", saveCard: "Save Card",
  ...
  bn: {
    ...
    breaking: "ব্রেকিং নিউজ", search: "সংবাদ খুঁজুন...", lead: "প্রধান খবর",
    ...
    dailyBrief: "ডেইলি ব্রিফ", stayInformed: "আমাদের সাথেই থাকুন",
    ...
    listen: "শুনুন", stop: "বন্ধ করুন", print: "Print", saveCard: "সেভ কার্ড",
    ...
    sponsored: "স্পনসরড", partnerFeature: "Exclusive Partner Feature", reads: "বার পঠিত",
